export function initParticles(canvas) {
    ...
    // Respecte prefers-reduced-motion: dessine une simple grille douce et stoppe l'animation
    ...
    function getColors() {
        ...
        if (mode === 'light') {
            return {
                dot: 'rgba(96,106,122,0.9)',
                line: 'rgba(96,106,122,0.9)',
                lineAlpha: 0.20,
                pointAlpha: 0.60
            };
        }
