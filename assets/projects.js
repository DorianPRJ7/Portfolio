export const UNIVERSITY_PROJECTS = [
  ...
  // Bases De Données
  {
    ...
    links: [
      { label: "Lire", href: "#" },
      { label: "<svg  width=\"20\" height=\"20\" role=\"img\" viewBox=\"0 0 24 24\" fill=\"currentColor\"><use href=\"#icon-github\"></use></svg>", href: "https://github.com/DorianPRJ7/projet-cmbd-L3" }
    ],
    img: ""
  },
  {
