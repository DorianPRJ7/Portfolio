export const UNIVERSITY_PROJECTS = [
  // Dev Web
  {
    ...
    links: [
      { label: "Lire", href: "#" },
      { label: "GitHub", icon: "icon-github", href: "https://github.com/ashigi444/projetCocktails" }
    ],
  ...
  },
  {
    ...
    links: [
      { label: "Lire", href: "#" },
      { label: "GitHub", icon: "icon-github", href: "https://github.com/DorianPRJ7/Star-Wars-Angular-Application" }
    ],
  ...
  // Dev Logiciel
  {
    ...
    links: [
      { label: "Lire", href: "#" },
      { label: "GitHub", icon: "icon-github", href: "https://github.com/DorianPRJ7/distributed-2d-geometry-engine" }
    ],
  ...
  },
  {
    ...
    links: [
      { label: "Lire", href: "#" },
      { label: "GitHub", icon: "icon-github", href: "https://github.com/DorianPRJ7/Jeu-du-Uno-PS4" }
    ],
  ...
  },
  {
    ...
    links: [
      { label: "Lire", href: "#" },
      { label: "GitHub", icon: "icon-github", href: "https://github.com/DorianPRJ7/Jeu-du-Pendu-PS4" }
    ],
  ...
  // Algos et IA
  {
    ...
    links: [
      { label: "Lire", href: "#" },
      { label: "GitHub", icon: "icon-github", href: "https://github.com/DorianPRJ7/Bentley-Ottmann-PS3" }
    ],
  ...
  },
  {
    ...
    links: [
      { label: "Lire", href: "#" },
      { label: "GitHub", icon: "icon-github", href: "https://github.com/DorianPRJ7/IA-ChessQuito" }
    ],
  ...
  },
  {
    ...
    links: [
      { label: "Lire", href: "#" },
      { label: "GitHub", icon: "icon-github", href: "https://github.com/DorianPRJ7/Projet_AAS" }
    ],
  ...
  // Bases De Données
  {
    ...
    links: [
      { label: "Lire", href: "#" },
      { label: "GitHub", icon: "icon-github", href: "https://github.com/DorianPRJ7/projet-cmbd-L3" }
    ],
    img: ""
  },
  {
    ...
    links: [
      { label: "Lire", href: "#" },
      { label: "GitHub", icon: "icon-github", href: "https://github.com/DorianPRJ7/vehicle-rental-database-oracle" }
    ],
    img: ""
  }
];
