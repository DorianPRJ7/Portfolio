export const UNIVERSITY_PROJECTS = [
  // Dev Web
  {
    title: "Maison &Eacute;lectra&nbsp;&mdash;&nbsp;Application Angular",
    category: "D&eacute;veloppement Web&nbsp;&&nbsp;Mobile",
    tags: ["Angular", "TypeScript", "SCSS", "Routing", "Reactive Forms"],
    description: "Single Page Application Angular pour la marque de parfums fictive Maison &Eacute;lectra. Catalogue interactif, syst&egrave;me de favoris, gestion des" +
        "avis avec formulaire r&eacute;actif et pr&eacute;visualisation en temps r&eacute;el.",
    details: "Projet r&eacute;alis&eacute; en Angular dans le cadre du module Technologies du Web en L3 Informatique &agrave; l'Universit&eacute; de Lorraine.\nLa marque Maison &Eacute;lectra est une entreprise fictive cr&eacute;&eacute;e lors du module Introduction aux Intelligences Artificielles G&eacute;n&eacute;ratives en L2. Ce projet en constitue l'extension web, une SPA Angular pr&eacute;sentant trois parfums (Storm Circuit, Volt Aria, Onyx Noir) avec un ensemble de fonctionnalit&eacute;s de navigation, de gestion des favoris et du syst&egrave;me d'avis.\nL'application permet de parcourir le catalogue, de consulter le d&eacute;tail de chaque parfum, de les marquer comme favoris et de les retrouver sur une page d&eacute;di&eacute;e, de lire et naviguer entre les avis, de consulter le d&eacute;tail d'un avis, de recommander ou supprimer un avis, et de soumettre un nouvel avis via un formulaire r&eacute;actif avec pr&eacute;visualisation en temps r&eacute;el.\nL'architecture suit le mod&egrave;le NgModule non-standalone : tous les composants sont d&eacute;clar&eacute;s dans AppModule, le routing est plat avec des routes param&eacute;tr&eacute;es imbriqu&eacute;es (/catalogue/:parfumId/avis/:avisId), et les donn&eacute;es sont g&eacute;r&eacute;es en m&eacute;moire via deux services singleton (ParfumService, AvisService) inject&eacute;s avec inject().\nLes concepts Angular mis en pratique sont la communication parent-enfant par @Input() (ParfumList → Parfum, AvisList → Avis), la navigation programmatique via Router, les pipes natifs (date, number, titlecase, async), un pipe personnalis&eacute; NoteEtoilesPipe convertissant une note num&eacute;rique en label textuel, une directive d'attribut personnalis&eacute;e MaDirective g&eacute;rant le surlignage au survol via ElementRef et le hook de cycle de vie OnInit.\nLe formulaire de cr&eacute;ation d'avis est impl&eacute;ment&eacute; en mode r&eacute;actif (FormGroup, FormControl, Validators) avec un Observable construit sur valueChanges.pipe(map(...)) et consomm&eacute; via le pipe async pour une pr&eacute;visualisation instantan&eacute;e.\nR&eacute;alis&eacute; avec Angular 21 et TypeScript.",
    links: [
      { label: "Lire", href: "#" },
      { label: "GitHub", href: "https://github.com/DorianPRJ7/maison-electra-web-app" }
    ],
    img: ""
  },
  {
    title: "Series Tracker&nbsp;&mdash;&nbsp;Application Ionic",
    category: "D&eacute;veloppement Web&nbsp;&&nbsp;Mobile",
    tags: ["Angular", "Ionic", "Capacitor", "TypeScript", "SCSS",
      "RxJS", "Reactive Forms", "API REST"],
    description: "Application mobile hybride Angular/Ionic de suivi de films et s&eacute;ries t&eacute;l&eacute;vis&eacute;es. Recherche en temps r&eacute;el via l'API TMDB, biblioth&egrave;que locale avec gestion du statut de visionnage et formulaire d'ajout r&eacute;actif.",
    details: "Projet r&eacute;alis&eacute; en Angular et Ionic dans le cadre du module D&eacute;veloppement Mobile en L3 Informatique  &agrave; l'Universit&eacute; de Lorraine.\nL'application permet de g&eacute;rer une biblioth&egrave;que personnelle de films et de s&eacute;ries, d'effectuer des recherches en temps r&eacute;el via l'API TMDB, de consulter la fiche d&eacute;tail de chaque &eacute;l&eacute;ment, de l'ajouter &agrave; la biblioth&egrave;que et de suivre son statut de visionnage (non vu, en cours, vu). La page d'accueil propose un carrousel des contenus non vus m&ecirc;lant films et s&eacute;ries, ainsi qu'une recherche globale croisant les deux types de contenus simultan&eacute;ment.\nL'architecture repose sur des NgModules non-standalone avec chargement paresseux, une navigation par onglets (/tabs/home, /tabs/movies, /tabs/series) avec routes imbriqu&eacute;es pour le d&eacute;tail et l'ajout, et trois services inject&eacute;s en singleton via inject() : MovieService et SerieService g&egrave;rent les biblioth&egrave;ques en m&eacute;moire, TmdbService centralise les appels HTTP &agrave; l'API TMDB.\nLes concepts Angular et Ionic mis en pratique sont la communication parent-enfant par @Input() et @Output(), la navigation programmatique via Router avec queryParams pour le retour contextuel, les directives modernes @for/@empty pour la gestion des listes &agrave; &eacute;tat vide, les formulaires r&eacute;actifs (FormGroup, FormControl, Validators) avec Observable construit sur valueChanges.pipe(map(...)) et consomm&eacute; via le pipe async pour la pr&eacute;visualisation de l'affiche en temps r&eacute;el, et HttpClient pour les requ&ecirc;tes vers l'API TMDB avec r&eacute;cup&eacute;ration des cr&eacute;dits en parall&egrave;le pour chaque r&eacute;sultat de recherche.\nLes donn&eacute;es sont conserv&eacute;es uniquement en m&eacute;moire, sans persistance locale. Le build web est synchronis&eacute; vers un projet iOS natif via Capacitor.\nR&eacute;alis&eacute; seul avec Angular 20, Ionic 8, Capacitor 8 et TypeScript 5.9.",
    links: [
      { label: "Lire", href: "#" },
      { label: "GitHub", href: "https://github.com/DorianPRJ7/series-tracker-web-mobile-app" }
    ],
    img: ""
  },
  {
    ...
    description: "Application web PHP de gestion de recettes de cocktails. Navigation par hi&eacute;rarchie d'ingr&eacute;dients, recherche avanc&eacute;e avec scoring, authentification et syst&egrave;me de favoris persistants.",
    details: "Projet r&eacute;alis&eacute; en PHP dans le cadre du module Conception d'Applications Web en L3 Informatique &agrave; l'Universit&eacute; de Lorraine.\nL'application permet de naviguer dans un catalogue de 108 recettes de cocktails organis&eacute;es selon une taxonomie hi&eacute;rarchique d'ingr&eacute;dients (ex. Alcool → Alcool fort → Rhum → Rhum blanc), d'effectuer des recherches avanc&eacute;es avec une syntaxe d&eacute;di&eacute;e (+ingr&eacute;dient voulu, -ingr&eacute;dient exclu, guillemets pour les expressions multi-mots) et un syst&egrave;me de score de pertinence exploitant les relations hi&eacute;rarchiques entre ingr&eacute;dients.\nL'application int&egrave;gre une authentification compl&egrave;te (inscription avec validation, hachage bcrypt, connexion, d&eacute;connexion, gestion de profil) et un syst&egrave;me de favoris &agrave; double persistance, session PHP pour les utilisateurs anonymes, fichiers s&eacute;rialis&eacute;s pour les utilisateurs connect&eacute;s.\nLa persistance des donn&eacute;es utilisateurs est assur&eacute;e par fichiers PHP (pas de base SQL), avec une architecture page-based centr&eacute;e sur un routeur unique (index.php) et une s&eacute;paration claire entre utilitaires, templates et assets.\nR&eacute;alis&eacute; en trin&ocirc;me, ce projet a permis de mettre en pratique la conception d'une application web compl&egrave;te en PHP, la gestion des sessions et de l'&eacute;tat utilisateur, ainsi que l'impl&eacute;mentation d'algorithmes de recherche et de filtrage.",
    links: [
      { label: "Lire", href: "#" },
  ...
  {
    title: "Application Angular&nbsp;&mdash;&nbsp;Star Wars (TP)",
    category: "D&eacute;veloppement Web&nbsp;&&nbsp;Mobile",
  ...
  // Dev Logiciel
  {
    title: "Moteur de g&eacute;om&eacute;trie 2D distribu&eacute;&nbsp;&mdash;&nbsp;C++/Java",
  ...
  },
  {
    ...
    description: "Client-serveur, sockets, DAO JDBC. Gestion compl&egrave;te des r&egrave;gles, parties, scores et comptes joueurs avec sauvegarde en base de donn&eacute;es.",
    details: "D&eacute;veloppement complet du jeu de cartes UNO en Java avec IntelliJ IDEA dans le cadre du projet de synth&egrave;se du second semestre de Licence 2 Informatique &agrave; l'Universit&eacute; de Lorraine.\nL'application repose sur une architecture client-serveur en Java/JavaFX, avec une gestion des parties, joueurs, cartes et r&egrave;gles via un mod&egrave;le orient&eacute; objet clair et modulaire.\nLe serveur centralise la logique du jeu, les tours, les effets de cartes et la communication r&eacute;seau, tandis que le client JavaFX, con&ccedil;u selon le mod&egrave;le MVC, propose une interface graphique intuitive pour jouer en multijoueur en ligne.\nLes scores, parties et comptes joueurs sont enregistr&eacute;s dans une base MySQL &agrave; l'aide de JDBC et d'une couche DAO.\nProjet r&eacute;alis&eacute; en trin&ocirc;me, centr&eacute; sur la mise en pratique des notions de POO, de r&eacute;seau et de bases de donn&eacute;es, ainsi que sur la qualit&eacute; du code (lisibilit&eacute;, extensibilit&eacute;, r&eacute;utilisabilit&eacute;) et la collaboration.",
    links: [
      { label: "Lire", href: "#" },
  ...
  {
    title: "Gestion de location de v&eacute;hicules&nbsp;&mdash;&nbsp;Triggers Oracle",
    category: "Bases de donn&eacute;es",
    tags: ["Oracle", "PL/SQL", "Triggers", "SQL", "MCD/MLD"],
    description: "Extension avanc&eacute;e d'un syst&egrave;me de location de v&eacute;hicules Oracle. Automatisation compl&egrave;te du cycle de vie des locations par triggers, retraite automatique des v&eacute;hicules et suivi du chiffre d'affaires en temps r&eacute;el.",
    details: "Projet r&eacute;alis&eacute; en PL/SQL dans le cadre du module optionnel Syst&egrave;mes de Gestion de Bases de Donn&eacute;es en L3 Informatique &agrave; l'Universit&eacute; de Lorraine, en extension du projet de gestion de location r&eacute;alis&eacute; en CMBD.\nL&agrave; o&ugrave; le projet CMBD reposait sur des proc&eacute;dures appel&eacute;es manuellement, ce projet d&eacute;l&egrave;gue toute la logique m&eacute;tier &agrave; 4 triggers BEFORE, cr&eacute;ation automatique de la date de retour et r&eacute;cup&eacute;ration du tarif &agrave; l'insertion d'une location, calcul des surcharges kilom&eacute;triques et mise &agrave; jour du chiffre d'affaires cumul&eacute; (CAV) au retour du v&eacute;hicule, validation des r&egrave;gles d'annulation (uniquement si le v&eacute;hicule n'a pas encore roul&eacute;) et int&eacute;grit&eacute; r&eacute;f&eacute;rentielle &agrave; l'archivage.\nLe cycle de vie complet des v&eacute;hicules est g&eacute;r&eacute; en base : disponible -> location -> retraite (d&eacute;clench&eacute;e automatiquement au d&eacute;passement de 50 000 km). Les codes d'erreur Oracle personnalis&eacute;s (-20001 &agrave; -20006) assurent une gestion explicite des violations de r&egrave;gles m&eacute;tier.\nLe projet inclut une suite de tests d&eacute;di&eacute;e couvrant les cas limites et anomalies, ainsi qu'une documentation MCD en plusieurs formats.\nR&eacute;alis&eacute; en trin&ocirc;me sur un sch&eacute;ma de 7 tables normalis&eacute;es.",
    links: [
      { label: "Lire", href: "#" },
...
export const PERSONNAL_PROJECTS = [
  {
    ...
    description: "Ce portfolio. Con&ccedil;u et d&eacute;velopp&eacute; from scratch en HTML/CSS/JS vanilla, sans framework. Architecture orient&eacute;e donn&eacute;es, animations canvas et CSS, th&egrave;me clair/sombre.",
    details: "Projet personnel con&ccedil;u et d&eacute;velopp&eacute; enti&egrave;rement en HTML, CSS et JavaScript vanilla, sans framework ni bundler.\nL'architecture repose sur une s&eacute;paration claire entre les donn&eacute;es (fichiers JS exportant les constantes de profil, projets, comp&eacute;tences, contact) et le rendu (main.js qui consomme ces donn&eacute;es et g&eacute;n&egrave;re le DOM dynamiquement).\nLe portfolio int&egrave;gre plusieurs animations comme un fond de particules interactif sur canvas, un effet de tilt 3D sur la carte hero, des boutons magn&eacute;tiques, et des animations d'apparition via IntersectionObserver.\nLe th&egrave;me clair/sombre est g&eacute;r&eacute; via un attribut data-theme sur la racine HTML, persist&eacute; en localStorage, avec synchronisation de la meta theme-color pour les navigateurs mobiles.\nLes ic&ocirc;nes sont centralis&eacute;es sous forme de sprite SVG inline, r&eacute;f&eacute;renc&eacute;es par <use href=\"#id\"> pour &eacute;viter les r&eacute;p&eacute;titions et faciliter la maintenance.\nLa navigation mobile est g&eacute;r&eacute;e en JS pur (menus d&eacute;pliants, fermetures au clic ext&eacute;rieur, ...).",
    links: [
      { label: "Lire", href: "#" },
